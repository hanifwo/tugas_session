...
if ( $error == 1 ) {
    echo "Terjadi Kesalahan Dalam proses input data <a href='login_sekolah.php>Kembali</a>'";
    exit();
}
...
if ( is_null($data) ) {
    echo "Email tidak terdaftar <a href ='login_sekolah.php'>Kembali</a>";
    exit();
}
else if ( $data['password'] != $password) {
    echo "Password salah <a href ='login_sekolah.php'>Kembali</a>";
    exit();
}
else {
