...
if( $error == 1 ) {
    echo "Terjadi kesalahan dalam proses input data! <a href='registration_sekolah.php'>Kembali</a>";
    exit();
}
...
if ( $insert == false ) {
    echo "Error dalam menambahkan data! <a href='registration_sekolah.php'>Kembali</a>";
}
else {
